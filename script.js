const SITE_URL = 'https://wheredidyoulearnit.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'Where Did You Learn It — Sonic Remedy | Soozhee', text: 'Where Did You Learn It by Soozhee. Sonic Remedy : Audiosensory Resonance | Letting Go.', url: SITE_URL }); return; } catch (e) {} }
